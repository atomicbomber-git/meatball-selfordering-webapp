...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="<?= base_url("outlet/store") ?>" >
                <input type="hidden"
                    name="<?= $this->csrf_name() ?>"
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="<?= $this->old("pajak_pertambahan_nilai") ?>"
                            >
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="<?= $this->old("print_server_url") ?>"
                            >
