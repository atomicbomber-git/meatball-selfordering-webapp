...
<div id="app">
    <outlet-menu-item-create submit_url="<?= base_url("outletMenuItem/store/{$outlet->id}") ?>" redirect_url="<?= base_url("outletMenuItem/index/{$outlet->id}/{$menu_category->id}") ?>" :menu_category='<?= json_encode($menu_category) ?>' />
</div