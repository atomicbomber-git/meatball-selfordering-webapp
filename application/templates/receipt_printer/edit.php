    ...
    <div class="card-block">
        ...
        <form method="POST" action="<?= base_url("receiptPrinter/update/{$receipt_printer->id}") ?>">
            ...
            <div class="form-group">
                ...
                <input name="name" id="name" type="text" class="form-control <?= $this->has_error("name") ? "error" : "" ?>" placeholder="Nama" value="<?= $this->old("name", $receipt_printer->name) ?>">
            ...
            <div class="form-group">
                ...
                <input name="ipv4_address" id="ipv4_address" type="text" class="form-control <?= $this->has_error("ipv4_address") ? "error" : "" ?>" placeholder="Alamat IP" value="<?= $this->old("ipv4_address", $receipt_printer->ipv4_address) ?>">
            ...
            <div class="form-group">
                ...
                <input name="port" id="port" type="text" class="form-control <?= $this->has_error("port") ? "error" : "" ?>" placeholder="Port" value="<?= $this->old("port", $receipt_printer->port) ?>">
            ...
            <div class="form-group">
                ...
                <select name="type" id="type" type="text" class="form-control <?= $this->has_error("type") ? "error" : "" ?>" placeholder="Tipe">
