...
<div class="card">
    <div class="card-block" id="app">
        <sales-invoice-update-and-confirm :sales_invoice='<?= json_encode($sales_invoice) ?>' :outlet_menu_items='<?= json_encode($outlet_menu_items) ?>' submit_url="<?= base_url("salesInvoice/processUpdateAndConfirm/{$sales_invoice->id}") ?>" redirect_url="<?= base_url("salesInvoice/index") ?>">
