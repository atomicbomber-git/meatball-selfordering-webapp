...
<?php $this->layout("shared/base", ["title" => "Ubah Pengguna"]) ?>
    ...
    <div class="card-block">
        <form method="POST" action="<?= base_url("user/update/{$user->id}") ?>">
            ...
            <div class="form-group">
                ...
                <input name="name" id="name" type="text" class="form-control <?= $this->has_error("name") ? "error" : "" ?>" placeholder="Nama Asli" value="<?= $this->old("name", $user->name) ?>">
            ...
            <div class="form-group">
                ...
                <input name="username" id="username" type="text" class="form-control <?= $this->has_error("username") ? "error" : "" ?>" placeholder="Nama Pengguna" value="<?= $this->old("username", $user->username) ?>">
            ...
            <div class="form-group">
                ...
                <select name="level" class="form-control <?= $this->has_error("level") ? "error" : "" ?>" id="level">
                    <?php foreach (UserLevel::LEVELS as $level => $label) : ?>
                        <option <?= $this->old("password", $user->level) === $level ? 'selected' : '' ?> value="<?= $level ?>">
                            <?= $label ?>
                        </option>
                    <?php endforeach ?>
                </select>
